...
static const char *highlight_init_light[] = {
  ...
  "Folded       ctermbg=Grey ctermfg=DarkBlue guibg=Grey guifg=DarkBlue",
  "FoldedLight  ctermbg=Grey ctermfg=DarkBlue guibg=LightGrey guifg=DarkBlue",
...
static const char *highlight_init_dark[] = {
  ...
  "FoldedLight  ctermbg=LightGrey ctermfg=Cyan guibg=LightGrey guifg=Cyan",
